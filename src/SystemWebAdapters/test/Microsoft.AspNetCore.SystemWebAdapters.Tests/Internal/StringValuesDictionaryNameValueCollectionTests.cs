...
{
    public class StringValuesDictionaryNameValueCollectionTests
    {
        private readonly Fixture _fixture;

        public StringValuesDictionaryNameValueCollectionTests()
        {
        ...
        public void PlatformNotSupportedExceptions()
        {
            ...
            var collection = new StringValuesDictionaryNameValueCollection(dictionary);
