...
{
    /// <summary>
    /// Extension methods for setting up Trello WebHooks in an <see cref="IMvcBuilder" />.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class TrelloMvcBuilderExtensions
    {
        /// <summary>
        /// <para>
        ...
        public static IMvcBuilder AddTrelloWebHooks(this IMvcBuilder builder)
        {
            if (builder == null)
            {
