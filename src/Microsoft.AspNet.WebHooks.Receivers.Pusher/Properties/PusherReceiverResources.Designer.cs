...
namespace Microsoft.AspNet.WebHooks.Properties {
    ...
    internal class PusherReceiverResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The event does not have a &apos;{0}&apos; property and as a result is ignored. Event data: &apos;{1}&apos;..
        /// </summary>
        internal static string Receiver_NoEventName {
            get {
                return ResourceManager.GetString("Receiver_NoEventName", resourceCulture);
            }
        }
