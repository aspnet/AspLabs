...
{
    /// <summary>
    /// Extension methods for setting up WordPress WebHooks in an <see cref="IMvcCoreBuilder" />.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class WordPressMvcCoreBuilderExtensions
    {
        /// <summary>
        /// <para>
        ...
        public static IMvcCoreBuilder AddWordPressWebHooks(this IMvcCoreBuilder builder)
        {
            if (builder == null)
            {
