...
namespace System.Net.Http
{
    ...
    {
        private static readonly MediaTypeFormatterCollection DefaultFormatters = new MediaTypeFormatterCollection();

        public static HttpRequestMessage CreateHttpRequestMessage(this HttpContext httpContext)
        {
            ...
            message.Options.Set<HttpContext>(new HttpRequestOptionsKey<HttpContext>(nameof(HttpContext)), httpContext);
            ...
            MediaTypeHeaderValue mediaType)
        {
            ...
            var formatters = DefaultFormatters;

            var formatter = formatters.FindWriter(typeof(T), mediaType);
            if (formatter == null)
            {
                throw new InvalidOperationException("Could not find a matching formatter.");
            }
        ...
        {
            request.Options.TryGetValue<T>(new HttpRequestOptionsKey<T>(key), out var value);
