...
namespace System.Web.Http
{
    ...
    public abstract class ApiController : IDisposable
    {
        ...
        [NonAction]
        public virtual IHttpActionResult BadRequest()
        {
            return new ShimStatusCodeResult(HttpStatusCode.BadRequest);
        }
        ...
        [NonAction]
        public virtual IHttpActionResult BadRequest(string message)
        {
            if (message == null)
            {
            ...
            return new NegotiatedContentResult<string>(HttpStatusCode.BadRequest, message);
        }
        ...
        public virtual IHttpActionResult BadRequest(ModelStateDictionary modelState)
        {
            ...
            return new NegotiatedContentResult<SerializableError>(HttpStatusCode.BadRequest, new SerializableError(modelState));
        }

        /// <summary>Creates a <see cref="ConflictResult"/> (409 Conflict).</summary>
        /// <returns>A <see cref="ConflictResult"/>.</returns>
        [NonAction]
        public virtual IHttpActionResult Conflict()
        {
            return new ShimStatusCodeResult(HttpStatusCode.Conflict);
        }
        ...
        [NonAction]
        public virtual IHttpActionResult Json<T>(T content)
        {
            if (content == null)
            {
        ...
        [NonAction]
        public virtual IHttpActionResult Json<T>(T content, JsonSerializerSettings serializerSettings)
        {
            if (content == null)
            {
                throw new ArgumentNullException(nameof(content));
        ...
        /// <returns>A <see cref="JsonResult"/> with the specified values.</returns>
        [NonAction]
        public virtual IHttpActionResult Json<T>(
            T content,
        ...
        {
            return new ShimStatusCodeResult(HttpStatusCode.NotFound);
        }
        ...
        {
            return new ShimStatusCodeResult(HttpStatusCode.OK);
        }
        ...
        [NonAction]
        public virtual IHttpActionResult Ok<T>(T content)
        {
            return new NegotiatedContentResult<T>(HttpStatusCode.OK, content);
        }
        ...
        [NonAction]
        public virtual IHttpActionResult ResponseMessage(HttpResponseMessage response)
        {
            if (response == null)
            {
        ...
        [NonAction]
        public virtual IHttpActionResult StatusCode(HttpStatusCode status)
        {
            return new ShimStatusCodeResult(status);
        }
