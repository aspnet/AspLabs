...
{
    /// <summary>
    /// Provides an <see cref="IWebHookReceiver"/> implementation which supports WebHooks generated by WordPress.
    ...
    {
        internal const string RecName = "wordpress";
        ...
        public override async Task<HttpResponseMessage> ReceiveAsync(string id, HttpRequestContext context, HttpRequestMessage request)
        {
            ...
            if (request.Method == HttpMethod.Post)
            {
                ...
                var action = data["hook"];
                if (string.IsNullOrEmpty(action))
                {
                    var message = string.Format(CultureInfo.CurrentCulture, WordPressReceiverResources.Receiver_BadBody, "hook");
