...
{
    /// <summary>
    /// Extension methods for setting up AzureContainerRegistry WebHooks in an <see cref="IMvcCoreBuilder" />.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class AzureContainerRegistryMvcCoreBuilderExtensions
    {
        /// <summary>
        /// <para>
