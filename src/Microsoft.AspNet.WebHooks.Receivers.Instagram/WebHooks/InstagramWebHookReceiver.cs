...
namespace Microsoft.AspNet.WebHooks
{
    ...
    public class InstagramWebHookReceiver : WebHookReceiver
    {
        ...
        protected virtual async Task<bool> VerifySignature(string id, HttpRequestMessage request)
        {
            ...
            {
                var message = string.Format(CultureInfo.CurrentCulture, InstagramReceiverResources.Receiver_BadHeaderEncoding, SignatureHeaderName);
        ...
        protected virtual async Task<HttpResponseMessage> WebHookVerification(string id, HttpRequestMessage request)
        {
            ...
            var challenge = queryParameters[ChallengeParameter];
            if (string.IsNullOrEmpty(challenge))
            {
                var message = string.Format(CultureInfo.CurrentCulture, InstagramReceiverResources.Receiver_NoChallenge, ChallengeParameter);
            ...
            var challengeResponse = request.CreateResponse();
        ...
        protected virtual IEnumerable<string> GetActions(JArray data, HttpRequestMessage request)
        {
            ...
            {
                var message = string.Format(CultureInfo.CurrentCulture, InstagramReceiverResources.Receiver_BadEvent, ex.Message);
                request.GetConfiguration().DependencyResolver.GetLogger().Error(message, ex);
