...
{
    public class SpecificWebHookEventNameMapperConstraintTest : WebHookConstraintTestBase
    {
        ...
        {
            // This constraint ignores the ReceiverName.
            Assert.True(result);
        }
        ...
        protected override IActionConstraint GetConstraint()
        {
            ...
            return new WebHookEventNameMapperConstraint(NullLoggerFactory.Instance, webHookEventMetadata.Object);
        }
