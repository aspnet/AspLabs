...
namespace Microsoft.AspNetCore.OpenApi.Generated
{
    ...
    file class XmlCommentTransformer : IOpenApiDocumentTransformer
    {
        internal static readonly Dictionary<(Type, string?), XmlComment> Cache = new()
        {
            ...
            { (typeof(global::Project), System.Text.Json.JsonNamingPolicy.CamelCase.ConvertName("Name")), new XmlComment("The name of the project.", null) },
            { (typeof(global::Project), System.Text.Json.JsonNamingPolicy.CamelCase.ConvertName("Description")), new XmlComment("The description of the project.", null) },
            { (typeof(global::Project), System.Text.Json.JsonNamingPolicy.CamelCase.ConvertName("Project")), new XmlComment("The project that contains <xref href=\"Todo\" data-throw-if-not-resolved=\"false\"></xref> items.", null) },
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "obe/fLnXu7F0elzz4KyjZZoAAABQcm9ncmFtLmNz")]
