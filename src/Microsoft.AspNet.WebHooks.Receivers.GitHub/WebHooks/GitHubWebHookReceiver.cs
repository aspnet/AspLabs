...
{
    /// <summary>
    /// Provides an <see cref="IWebHookReceiver"/> implementation which support WebHooks generated by GitHub. 
    ...
    {
        internal const string SecretKey = "MS_WebHookReceiverSecret_GitHub";
        ...
        private static readonly string[] ReceiverNames = new string[] { "github" };
