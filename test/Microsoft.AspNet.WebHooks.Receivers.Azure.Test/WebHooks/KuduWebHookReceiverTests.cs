...
namespace Microsoft.AspNet.WebHooks
{
    ...
    {
        private const string TestContent = "{ \"id\": \"ff17489fbcb7e2dda9012ec285811b9b751ebb5e\", \"status\": \"success\", \"statusText\": \"\", \"authorEmail\": \"henrikn@microsoft.com\", \"author\": \"Henrik Frystyk Nielsen\", \"message\": \"initial commit\n\", \"progress\": \"\", \"deployer\": \"HenrikN\", \"receivedTime\": \"2015-09-26T04:26:53.8736751Z\", \"startTime\": \"2015-09-26T04:26:54.2486694Z\", \"endTime\": \"2015-09-26T04:26:55.6393049Z\", \"lastSuccessEndTime\": \"2015-09-26T04:26:55.6393049Z\", \"complete\": true, \"siteName\": \"henriknweb8\" }";
        ...
        {
            // Arrange
            IWebHookReceiver rec = new KuduWebHookReceiver();
            string expected = "kudu";

            // Act
            string actual1 = rec.Name;
            string actual2 = KuduWebHookReceiver.ReceiverName;
        ...
        public async Task ReceiveAsync_Throws_IfPostIsNotUsingHttps()
        {
            ...
            Assert.Equal("The WebHook receiver 'KuduWebHookReceiverProxy' requires HTTPS in order to be secure. Please register a WebHook URI of type 'https'.", error.Message);
        ...
        public async Task ReceiveAsync_Succeeds_IfValidPostRequest(string id)
        {
            ...
            List<string> actions = new List<string> { "success" };
            ReceiverMock.Protected()
