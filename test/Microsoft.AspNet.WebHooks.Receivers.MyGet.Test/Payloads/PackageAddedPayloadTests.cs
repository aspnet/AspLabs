...
{
    public class PackageAddedPayloadTests
    {
        [Fact]
        public void PackageAddedPayload_Roundtrips()
        {
            ...
            PackageAddedPayload expected = new PackageAddedPayload
            {
                ...
                PackageDetailsUrl = new Uri("https://www.myget.org/feed/sample-feed/package/GoogleAnalyticsTracker.WP8/1.0.0-CI00002"),
                PackageDownloadUrl = new Uri("https://www.myget.org/F/sample-feed/api/v2/package/GoogleAnalyticsTracker.WP8/1.0.0-CI00002"),
