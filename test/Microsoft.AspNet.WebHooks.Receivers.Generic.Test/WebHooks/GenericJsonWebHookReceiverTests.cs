...
namespace Microsoft.AspNet.WebHooks
{
    public class GenericJsonWebHookReceiverTests : WebHookReceiverTestsBase<GenericJsonWebHookReceiver>
    {
        ...
        {
            // Arrange
            IWebHookReceiver rec = new GenericJsonWebHookReceiver();
            string expected = "genericjson";

            // Act
            string actual1 = rec.Name;
            string actual2 = GenericJsonWebHookReceiver.ReceiverName;
        ...
        [Theory]
        [MemberData(nameof(ValidPostData))]
